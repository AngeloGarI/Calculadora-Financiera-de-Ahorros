...
while True:
    ...
    # Opción 4: Meta de ahorro
    elif opcion == "4":
        meta = float(input("Ingrese la meta de ahorro: "))
        tiempo = int(input("Ingrese el tiempo en meses: "))
        tasa = float(input("Ingrese la tasa de interés (0 si no aplica): "))
        mensual = calcular_meta_de_ahorro_(meta, tiempo, tasa)
        print(f"Debe ahorrar aproximadamente {mensual:.2f} cada mes.")
